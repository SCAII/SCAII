...
class TestFlattenings(unittest.TestCase):
    ...
    def test_get_key_for_line(self):
        ...
        self.assertEqual("jumpToDecisionPoint",get_key_for_line("tutorial.scr,9-13-2018,13:50:53:770,1536871853770,1,1.0,userClick:195_404;region:gameArea;target:expl-control-canvas;timelineClick:57,false,false,false,false,false,false"))
