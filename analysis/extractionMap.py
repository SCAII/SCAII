def get_extraction_map(): 
    ...
    extractionMap["clickTimeLineBlocker"] =       "fileName,date,time,1970Sec,decisionPoint,questionId,OMIT,userClick.coordX,userClick.coordY,OMIT,userClick.region,OMIT,userClick.target,NOTE_PRESENCE>userClick.clickTimeLineBlocker,OMIT" # add logic so if NA change to yes
    extractionMap["play"] =                       "fileName,date,time,1970Sec,decisionPoint,questionId,OMIT,userClick.coordX,userClick.coordY,OMIT,userClick.region,OMIT,userClick.target,NOTE_PRESENCE>userClick.play,OMIT" # add logic so if NA change to yes
    extractionMap["pause"] =                      "fileName,date,time,1970Sec,decisionPoint,questionId,OMIT,userClick.coordX,userClick.coordY,OMIT,userClick.region,OMIT,userClick.target,NOTE_PRESENCE>userClick.pause,OMIT" # add logic so if NA change to yes
    extractionMap["touchStepProgressLabel"] =     "fileName,date,time,1970Sec,decisionPoint,questionId,OMIT,userClick.coordX,userClick.coordY,OMIT,userClick.region,OMIT,userClick.target,NOTE_PRESENCE>userClick.touchStepProgressLabel,OMIT" # add logic so if NA change to yes
