...
class test_flattening_explan(unittest.TestCase):
    ...
    def test_clickSaliencyMap(self):
        ...
        self.assertEqual(obj["userClick.clickSaliencyMap.clickGameEntity"], "endMouseOverSaliencyMap")
        self.assertEqual(obj["userClick.clickSaliencyMap.clickQuadrant"], "upperRightQuadrant")
