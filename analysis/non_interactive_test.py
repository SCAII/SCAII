...
class test_flattening_non_interactive(unittest.TestCase):
    ...
    def test_userClick(self):
        ...
        self.assertEqual(obj["userClick.answerQuestion.userClick"], "yes") # TODO ask Jed about this non interactive one
    ...
    def test_clickActionLabel(self):
        ...
        self.assertEqual(obj["userClick.clickActionLabel"], "D2ESCAPED-COLON Attack Q4")
        self.assertEqual(obj["userClick.clickActionLabelDenied"], "NA")
        self.assertEqual(obj["userClick.selectedRewardBar"], "NA")
   ...
   def test_clickActionLabelDenied(self):
        ...
        self.assertEqual(obj["userClick.clickActionLabel"], "NA")
        self.assertEqual(obj["userClick.clickActionLabelDenied"], "D2ESCAPED-COLON Attack Q4")
        self.assertEqual(obj["userClick.selectedRewardBar"], "NA")
