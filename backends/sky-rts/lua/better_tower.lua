-- A modified version fo tower_example with slight HP randomization
-- to torture test more layers of saliency.
--
-- Use with map_override="better_tower" in a demo when construction a TowerExample.
