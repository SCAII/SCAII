function runMsxChartDataColorTests (failureChecker, chartTesting) {
    ...
    if (chartTesting == "seeSaw") {
        ...
        fc.assert(ch.actionRewardForNameMap["action_0.reward_1"].msxColor, "#C0C0C0", "color 0.1");
        fc.assert(ch.actionRewardForNameMap["action_0.reward_2"].msxColor, "#30481E", "color 0.2");

        fc.assert(ch.actionRewardForNameMap["action_1.reward_0"].msxColor, "#C0C0C0", "color 1.0");
        fc.assert(ch.actionRewardForNameMap["action_1.reward_1"].msxColor, "#C0C0C0", "color 1.1");
        fc.assert(ch.actionRewardForNameMap["action_1.reward_2"].msxColor, "#30481E", "color 1.2");

        fc.assert(ch.actionRewardForNameMap["action_2.reward_0"].msxColor, "#C0C0C0", "color 2.0");
        fc.assert(ch.actionRewardForNameMap["action_2.reward_1"].msxColor, "#C0C0C0", "color 2.1");
        fc.assert(ch.actionRewardForNameMap["action_2.reward_2"].msxColor, "#C0C0C0", "color 2.2");

        fc.assert(ch.actionRewardForNameMap["action_3.reward_0"].msxColor, "#C0C0C0", "color 3.0");
        fc.assert(ch.actionRewardForNameMap["action_3.reward_1"].msxColor, "#C0C0C0", "color 3.1");
        fc.assert(ch.actionRewardForNameMap["action_3.reward_2"].msxColor, "#30481E", "color 3.2");

    } else if (chartTesting == "allPositives") {
        fc.setCase("allPositives Color");

        fc.assert(ch.actionRewardForNameMap["action_0.reward_0"].msxColor, "#C0C0C0", "color 0.0");
        fc.assert(ch.actionRewardForNameMap["action_0.reward_1"].msxColor, "#C0C0C0", "color 0.1");
        fc.assert(ch.actionRewardForNameMap["action_0.reward_2"].msxColor, "#30481E", "color 0.2");
    
        fc.assert(ch.actionRewardForNameMap["action_1.reward_0"].msxColor, "#C0C0C0", "color 1.0");
        fc.assert(ch.actionRewardForNameMap["action_1.reward_1"].msxColor, "#E1974C", "color 1.1");
        fc.assert(ch.actionRewardForNameMap["action_1.reward_2"].msxColor, "#C0C0C0", "color 1.2");
        ...
        fc.assert(ch.actionRewardForNameMap["action_3.reward_0"].msxColor, "#C0C0C0", "color 3.0");
        fc.assert(ch.actionRewardForNameMap["action_3.reward_1"].msxColor, "#C0C0C0", "color 3.1");
        fc.assert(ch.actionRewardForNameMap["action_3.reward_2"].msxColor, "#C0C0C0", "color 3.2");
        ...
        fc.assert(ch.actionRewardForNameMap["action_0.reward_0"].msxColor, "#C0C0C0", "color 0.0");
        fc.assert(ch.actionRewardForNameMap["action_0.reward_1"].msxColor, "#C0C0C0", "color 0.1");
        fc.assert(ch.actionRewardForNameMap["action_0.reward_2"].msxColor, "#C0C0C0", "color 0.2");
