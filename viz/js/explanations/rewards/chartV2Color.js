function addColorToBars(rawChartData) {
    ...
    //possible solution: don't use ch.rewardBars variable in colorTests?
    var colors = ['#00AAAA', '#0055CC', '#00CC00', '#004400', '#0000AA', '#006666', '#002222', '#000044']

    for (var i in rd.actions) {
        for (var j in rd.actions[i].bars) {
            rd.actions[i].bars[j].color = colors[j];
        }
    }
