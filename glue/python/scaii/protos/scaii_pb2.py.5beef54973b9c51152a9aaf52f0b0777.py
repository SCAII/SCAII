...
import scaii.env.cfg_pb2 as cfg__pb2
import scaii.env.viz_pb2 as viz__pb2
...
_SCAIIPACKET = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='other', full_name='scaii.common.ScaiiPacket.other', index=24,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='src', full_name='scaii.common.ScaiiPacket.src', index=25,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='dest', full_name='scaii.common.ScaiiPacket.dest', index=26,
...
_ACTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='explanation_point', full_name='scaii.common.Action.explanation_point', index=3,
      number=4, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_ACTION.fields_by_name['explanation_point'].message_type = viz__pb2._EXPLANATIONPOINT
