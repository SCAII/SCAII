...
_ENTITY = _descriptor.Descriptor(
  ...
  nested_types=[_ENTITY_BOOLMETADATAENTRY, _ENTITY_INTMETADATAENTRY, _ENTITY_FLOATMETADATAENTRY, _ENTITY_STRINGMETADATAENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
